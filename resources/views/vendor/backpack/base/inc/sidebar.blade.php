    ...
    <aside class="main-sidebar">
        ...
        <section class="sidebar">
            ...
            <!-- ================================================ -->
                ...
                @can('list_categories')
                    <li><a href="{{ url(config('backpack.base.route_prefix', 'admin').'/categories') }}"><i
                                    class="fa fa-bars"></i> <span>{{ trans('category.categories') }}</span></a></li>
                @endcan

                @can('list_products')
                    <li><a href="{{ url(config('backpack.base.route_prefix', 'admin').'/products') }}"><i
                                    class="fa fa-list"></i> <span>{{ trans('product.products') }}</span></a></li>
                @endcan

                <li><a href="{{ url(config('backpack.base.route_prefix', 'admin').'/orders') }}"><i
                                class="fa fa-list-ul"></i> <span>{{ trans('order.orders') }}</span></a></li>
                ...
                @can('list_clients')
                    <li>
                        <a href="{{ url(config('backpack.base.route_prefix', 'admin').'/gift-cards') }}">
                            ...
                            <span>{{ trans('gift_card.gift_card') }}</span>
                        </a>
                    </li>
                @endcan
                @can('list_attributes')
                    <li><a href="{{ url(config('backpack.base.route_prefix', 'admin').'/attributes') }}"><i
                                    class="fa fa-tag"></i> <span>{{ trans('attribute.attributes') }}</span></a></li>
                @endcan

                @can('list_attribute_sets')
                    <li><a href="{{ url(config('backpack.base.route_prefix', 'admin').'/attributes-sets') }}"><i
                                    class="fa fa-tags"></i> <span>{{ trans('attribute.attribute_sets') }}</span></a>
                    </li>
                @endcan
            <!--
          @can('list_currencies')
          ...
          @endcan
                ...
                @can('list_notification_templates')
                    <li><a href="{{ url(config('backpack.base.route_prefix', 'admin').'/notification-templates') }}"><i
                                    class="fa fa-list"></i>
                            <span>{{ trans('notification_templates.notification_templates') }}</span></a></li>
                @endcan
                ...
                <li class="treeview">
                    ...
                    <ul class="treeview-menu">
                        <li><a href="{{ url(config('backpack.base.route_prefix', 'admin') . '/users') }}"><i
                                        class="fa fa-user"></i> <span>{{ trans('user.users') }}</span></a></li>
