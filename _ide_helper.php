 ...
 * Generated for Laravel 5.5.32 on 2020-02-15 14:02:52.
 *
...
namespace Collective\Html { 
    ...
    class FormFacade {
         ...
         * @static 
         */ 
        public static function select($name, $list = [], $selected = null, $selectAttributes = [], $optionsAttributes = [])
        {
                        /** @var \Collective\Html\FormBuilder $instance */
         ...
         * @static 
         */ 
        public static function getSelectOption($display, $value, $selected, $attributes = [])
        {
                        /** @var \Collective\Html\FormBuilder $instance */
